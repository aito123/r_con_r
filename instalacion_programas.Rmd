...
**Paso 3** : Haces click en "Install R fot the first time" si es la primera vez que bajas R, en "base" si ya haz descargado antes R y quieres la nueva versión. Una vez descargados regresaremos a esta pagina y haremos click en "R-tool"(Más adelante se especificaran los pasos.)

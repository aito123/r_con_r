...
diccionarios$renamu_m4_2016 %>% as.data.frame() %>% mutate(across(everything(), as.character)) %>% export("renamu_m4_2016_dic1.xlsx")
diccionarios$renamu_m4_2017 %>% as.data.frame() %>% mutate(across(everything(), as.character)) %>% export("renamu_m4_2017_dic1.xlsx")
diccionarios$renamu_m4_2018 %>% as.data.frame() %>% mutate(across(everything(), as.character)) %>% export("renamu_m4_2018_dic1.xlsx")
diccionarios$renamu_m4_2019 %>% as.data.frame() %>% mutate(across(everything(), as.character)) %>% export("renamu_m4_2019_dic1.xlsx")
diccionarios$renamu_m4_2020 %>% as.data.frame() %>% mutate(across(everything(), as.character)) %>% export("renamu_m4_2020_dic1.xlsx")
